...
if (euroAmount > 0 && dollarAmount > 0){
    ...
    hryvniaAmountEUR = Math.round(hryvniaAmountEUR * 1000) / 1000; //round

    var hryvniaAmountUSD = dollarAmount * dollar;
    hryvniaAmountUSD = Math.round(hryvniaAmountUSD * 1000) / 1000; //round

    var EUR2USDCurrency = euro/dollar;
    EUR2USDCurrency = Math.round(EUR2USDCurrency * 1000) / 1000; //round
